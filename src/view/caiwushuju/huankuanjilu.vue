    ...
    <div class="topBanner">
      <div class="content">
        <div class="searcharea">
          ...
          <el-form ref="searchform" :model="searchform" label-width="90px" size="mini">
            <el-row :gutter="30">
              ...
              <el-col :span="6">
                <el-form-item label="实还款时间" prop="beginDate">
                  <el-date-picker
                    class="shi"
                    clearable
        ...
        >
          ...
          <el-table-column prop="productCode" label="还款本金" align="center"></el-table-column>
          <el-table-column prop="preApproveMoney" label="还款利息" align="center"></el-table-column>
          <el-table-column prop="preApproveTerm" label="还款服务费" align="center"></el-table-column>
          <el-table-column prop="preApproveMonthRate" label="还款总额" align="center"></el-table-column>
          <el-table-column prop="preApproveMonthRate" label="实还款时间" align="center"></el-table-column>
        </el-table>
        <!-- 分页 -->
        <div class="block">
          <el-pagination
