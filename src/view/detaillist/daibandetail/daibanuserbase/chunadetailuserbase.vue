  ...
  <div>
    ...
    <div class="el-table">
      <table width="100%">
        ...
        <ul class="tab-ul">
          <li>
            <label >放款金额（元）：</label>{{detail.creditLimit}}
          </li>
          <li>
            <label >日利率（%）：</label>{{detail.creditRate}}</li>
          <li>
            <label >借款天数（天）：</label>{{detail.applicationDeadline}}</li>
...
<div class="el-table el-table--fit  el-table--enable-row-hover el-table--enable-row-transition">
    ...
    <div class="el-table el-table--fit  el-table--enable-row-hover el-table--enable-row-transition">
      ...
      <table width="100%">
        ...
        <li style="width:100%">
            <label >放款金额：</label>
            <span>{{detail.creditLimit}}</span></li>
